...
SCHEMA_PATH = Path('/Users/administrador/Desktop/FlowMind/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin': '/Users/administrador/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-darwin'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    llmconfig: 'actions.LLMConfigActions[models.LLMConfig]'
    ...
    def __init__(
        ...
        *,
        ...
        self.llmconfig = actions.LLMConfigActions[models.LLMConfig](self, models.LLMConfig)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/administrador/Desktop/FlowMind/prisma/schema.prisma',
        }
...
class Batch:
    ...
    llmconfig: 'LLMConfigBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.llmconfig = LLMConfigBatchActions(self)
